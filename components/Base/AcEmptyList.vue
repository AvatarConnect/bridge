...
<template>
  <div class="ac-empty-list">
    <img
      src="/illustrations/sleepy-face.png"
...
export default {
  name: 'AcEmptyList',
  props: {
    /** Sets the subtitle for the empty list */
    subtitle: {
      default() {
    ...
    /** Sets the title for the emtpy list */
    title: {
      default() {
        return this.$t('title')
      },
...
.ac-empty-list {
  ...
  &__title {
    @apply font-normal mb-1 text-xl;
  }
}
</style>
